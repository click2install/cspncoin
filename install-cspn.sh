...
COIN_DAEMON='/usr/local/bin/csportsd'
COIN_CLI='/usr/local/bin/csports-cli'
COIN_REPO='https://github.com/c-sports/CSPN-Core/releases/download/1.0.1.0-l33t/csports-1.0.1.0-l33t-linux.tar.gz'
SENTINEL_REPO=
COIN_NAME='CSPN'
COIN_PORT=13370
RPC_PORT=13371
...
function compile_node() {
  ...
  tar --strip-components=1 xvzf $COIN_ZIP >/dev/null 2>&1
  compile_error
  cp csports* /usr/local/bin
  compile_error
